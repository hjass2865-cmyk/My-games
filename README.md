...
<!-- GAMES -->
<div id="coin" class="game"><h3>🪙 Coin Flip</h3><button onclick="coinFlip('heads')">Heads</button><button onclick="coinFlip('tails')">Tails</button></div>
<div id="dice" class="game"><h3>🎲 Dice Odd/Even</h3><button onclick="diceRoll('odd')">Odd</button><button onclick="diceRoll('even')">Even</button></div>
<div id="lucky7" class="game"><h3>🍀 Lucky 7</h3><button onclick="luckySeven()">Bet $10</button></div>
<div id="slots" class="game"><h3>🎰 Slot Machine</h3><button onclick="slotMachine()">Spin $10</button></div>
<div id="roulette" class="game"><h3>🎡 Roulette</h3><button onclick="roulette('red')">Red</button><button onclick="roulette('black')">Black</button></div>
<div id="blackjack" class="game"><h3>🃏 Blackjack</h3><button onclick="blackjackStart()">Play $10</button></div>
<div id="guess" class="game"><h3>🔢 Number Guess</h3><button onclick="numberGuess()">Play $10</button></div>
<div id="rps" class="game"><h3>✊ Rock Paper Scissors</h3><button onclick="rps('rock')">Rock</button><button onclick="rps('paper')">Paper</button><button onclick="rps('scissors')">Scissors</button></div>
<div id="lotto" class="game"><h3>🎟️ Jackpot Lotto</h3><button onclick="lotto()">Play $10</button></div>
<div id="horse" class="game"><h3>🐎 Horse Race</h3><button onclick="horseRace(1)">Horse 1</button><button onclick="horseRace(2)">Horse 2</button><button onclick="horseRace(3)">Horse 3</button><button onclick="horseRace(4)">Horse 4</button></div>
<div id="war" class="game"><h3>⚔️ War</h3><button onclick="war()">Draw Card</button></div>
<div id="higher" class="game"><h3>⬆️ Higher Card</h3><button onclick="higherCard()">Play $10</button></div>
<div id="craps" class="game"><h3>🎲 Craps Lite</h3><button onclick="craps()">Roll Dice</button></div>
<div id="wheel" class="game"><h3>🎡 Wheel of Fortune</h3><button onclick="wheel()">Spin</button></div>
<div id="robbery" class="game"><h3>💰 Bank Robbery</h3><button onclick="robbery()">Attempt $10</button></div>
<div id="double" class="game"><h3>💵 Double or Nothing</h3><button onclick="doubleOrNothing()">Play $10</button></div>
<div id="crash" class="game"><h3>📈 Crash Game</h3><button onclick="crash()">Start $10</button></div>
<div id="hotcold" class="game"><h3>🔥 Hot or Cold</h3><button onclick="hotCold()">Play $10</button></div>
<div id="doors" class="game"><h3>🚪 Lucky Doors</h3><button onclick="doors(1)">Door 1</button><button onclick="doors(2)">Door 2</button><button onclick="doors(3)">Door 3</button></div>
<div id="highroll" class="game"><h3>🎲 High Roll</h3><button onclick="highRoll()">Roll $10</button></div>
